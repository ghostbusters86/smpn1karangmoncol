...
$sql = mysql_query("SELECT * FROM student WHERE nis = '$_SESSION[id_siswa]' ");
          ...
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header kuning">
                        ...
                        <h4 class="title-putih"><i class="fa fa-pencil"></i> Edit Data Profil</h4>
                      </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-7">
                            ...
                            <input type="text" readonly class="form-control" name="nis" value="<?php echo $row['nis']; ?>" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <?php 
                      $qkls = mysql_query("SELECT * FROM class WHERE class_id ='$row[class_id]' ");
                      $kls = mysql_fetch_assoc($qkls);
                       ?>
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-4"><label>Kelas</label></div>
                          <div class="col-md-4">
                          	<input type="hidden" name="kelas" value="<?php echo $kls['class_id']; ?>">
                            <input type="text" readonly class="form-control" value="<?php echo $kls['class_name']; ?>" required>
                          </div>
                        </div>
                      </div>
