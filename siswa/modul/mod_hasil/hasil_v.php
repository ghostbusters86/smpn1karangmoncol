                ...
                <div class="table-responsive">
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                       $qry = mysql_query("SELECT * FROM exm_reg, process_exm, exm_result WHERE exm_reg.exm_reg_id = process_exm.exm_reg_id AND process_exm.process_exm_id = exm_result.process_exm_id AND exm_reg.nis = '$_SESSION[id_siswa]' ");
