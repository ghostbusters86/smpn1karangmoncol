...
<head>
  ...
  <title>Ujian Online | SMP Negeri 1 Karangmoncol</title>
  ...
  <header>
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="logo">
            <h1><a href="media.php?module=home">Ujian <span class="bold">Online</span></a></h1>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="<?php if ($_GET[module] == 'jadwal') {echo "open";} ?>"><a href="media.php?module=jadwal"><i class="fa fa-calendar"></i> Jadwal Ujian</a></li>

          <li class="<?php if ($_GET[module] == 'daftar') {echo "open";} ?>"><a href="media.php?module=daftar"><i class="fa fa-file-text"></i> Pendaftaran Ujian</a></li>

          <li class="<?php if ($_GET[module] == 'ujian') {echo "open";} ?>"><a href="media.php?module=ujian"><i class="fa fa-pencil"></i> Ujian</a></li>
