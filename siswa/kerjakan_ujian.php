                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    /*start metode lcg*/
                     ...
                     $dgs     = mysql_fetch_assoc($sg);
                     $reg     = mysql_query("SELECT * FROM exm_reg WHERE exm_schedule_id = '$row[exm_schedule_id]' AND nis = '$_SESSION[id_siswa]' ");
                     $dreg    = mysql_fetch_assoc($reg);
                     $for     = mysql_query("SELECT * FROM formula_lcg WHERE formula_lcg_id = '$row[formula_lcg_id]' ");
                     $fml     = mysql_fetch_assoc($for);
                     // print_r($fml);
