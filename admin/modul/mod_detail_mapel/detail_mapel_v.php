                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            while ($mapel = mysql_fetch_assoc($data)) { ?>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            while ($guru = mysql_fetch_assoc($data)) { ?>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <select name="guru" class="form-control selectlive" required>
                              <?php 
                              $sql = mysql_query("SELECT * FROM teacher WHERE nip ='$row[nip]'");
                              $tch = mysql_fetch_assoc($sql);
                              ?>
                            <option value="<?php echo $tch['nip']; ?>"><?php echo $tch['name']; ?> </option>

                              <?php 
                             $sql = mysql_query("SELECT * FROM teacher WHERE NOT nip ='$row[nip]' ORDER BY name ASC ");
                             while ($tch = mysql_fetch_assoc($sql)) { ?>
                              <option value="<?php echo $tch['nip']; ?>"><?php echo $tch['name']; ?></option>
                             <?php } ?>                            
      ...
      <div id="blokir<?php echo $row['detail_lesson_id']; ?>" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      ...
                      $pel = mysql_fetch_assoc($spel);
                      $sgr = mysql_query("SELECT * FROM teacher WHERE nip = '$row[nip]' ");
                      $guru = mysql_fetch_assoc($sgr);
                       ?>
