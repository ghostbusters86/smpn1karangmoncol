            ...
            <div class="col-md-6">            
             <div class="widget">
                ...
                <div class="widget-content">
                  ...
                  <?php 
                  $data['sql'] = mysql_query("SELECT * FROM admin WHERE username = '{$_SESSION["namauser"]}' ");
                  $data['row'] = mysql_fetch_assoc($data['sql']);
                   ?>
            ...
            <div class="modal-content">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4"><label>Nama Lengkap</label></div>
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="nama" value="<?php echo $data['row']['name']; ?>" required>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4"><label>Username</label></div>
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="username" value="<?php echo $data['row']['username']; ?>" required>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4"><label>Alamat</label></div>
                  <div class="col-md-8">
                    <textarea class="form-control" name="alamat" required><?php echo $data['row']['address']; ?></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4"><label>No Tlp</label></div>
                  <div class="col-md-5">
                    <input type="text" class="form-control" name="no_telp" value="<?php echo $data['row']['no_telp']; ?>" required>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4"><label>Email</label></div>
                  <div class="col-md-6">
                    <input type="email" class="form-control" name="email" value="<?php echo $data['row']['email']; ?>" required>
                  </div>
                </div>
              </div>
