...
?>
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-text"></i> Mata Pelajaran</h2> 
        <div class="bread-crumb pull-right">
          <a href="media.php?module=home"><i class="fa fa-home"></i> Home</a>
          <span class="divider">/</span> 
          <a href="media.php?module=mapel" class="bread-current">Mata Pelajaran</a>
        </div>
                ...
                <div class="table-responsive">
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      $data = mysql_query("SELECT * FROM lesson");
                      ...
                      <tr>
                        ...
                        <a href="#edit<?php echo $row['lesson_id']; ?>" data-toggle="modal"><button type="button" class="btn btn-sm btn-warning" title="edit"><i class="fa fa-pencil"></i></button></a>
          ...
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header biru">
                        ...
                        <h4 class="title-putih"><i class="fa fa-plus"></i> Tambah Data Mata Pelajaran</h4>
                      </div>
...
<!-- Edit Data -->
    <?php 
                      ...
                      while ($row = mysql_fetch_assoc($data)) {                      
    ?>       
      <div id="edit<?php echo $row['lesson_id']; ?>" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header kuning">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-close"></i></button>
                        <h4 class="title-putih"><i class="fa fa-pencil"></i> Edit Data Mata Pelajaran</h4>
                      </div>
                      <div class="modal-body">
                     ...
                     <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text"  class="form-control" name="nama_pelajaran" value="<?php echo $row['lesson_name']; ?>" required>
                          </div>
                        </div>
                      </div>
...
<!-- Blokir Data -->
    <?php 
                      ...
                      while ($row = mysql_fetch_assoc($data)) {                      
    ?>    
      <div id="blokir<?php echo $row['lesson_id']; ?>" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header merah">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-close"></i></button>
                        <h4 class="title-putih">Non Aktifkan Data Mata Pelajaran</h4>
                      </div>
                      <div class="modal-body">
                      ...
                      Apakah Anda ingin Non Aktifkan Mata Pelajaran <b><?php echo $row['lesson_name']; ?></b> ? 
                      Jika Mata Pelajaran <b><?php echo $row['lesson_name']; ?></b> di Non Aktifkan, maka user yang mengambil Mata Pelajaran <b><?php echo $row['lesson_name']; ?></b> tidak akan terbaca didalam sistem ini.  
                      </div>
