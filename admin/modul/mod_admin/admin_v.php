...
?>
	    ...
	    <div class="page-head">
	      <h2 class="pull-left"><i class="fa fa-users"></i> Users Admin</h2> 
                ...
                <div class="table-responsive">
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      $data = mysql_query("SELECT * FROM admin order by username ASC");
                      ...
                      <tr>
                        ...
                        <td width="120px">
                          ...
                          <a href="#detail<?php echo $row['username']; ?>" data-toggle="modal"><button type="button" class="btn btn-sm btn-info" title="detail"><i class="fa fa-eye"></i></button></a>

                          <a href="#edit<?php echo $row['username']; ?>" data-toggle="modal"><button type="button" class="btn btn-sm btn-warning" title="edit"><i class="fa fa-pencil"></i></button></a>
                          

                          <?php 
                          if ($_SESSION['namauser']==$row['username']) {
                            echo " ";
                          }else{?>
                           <?php if ($row['block']=='Y') {?>
                          <a href="<?php echo $module; ?>&act=aktif&id=<?php echo $row['username']; ?>"><button type='button' class='btn btn-sm btn-success' title="Aktifkan"><i class="fa fa-check"></i></button>
                          <?php }elseif ($row['block']=='N') {?> 
                          <a href="#blokir<?php echo $row['username']; ?>" data-toggle="modal"><button type='button' class='btn btn-sm btn-danger' title="Blokir"><i class="fa fa-ban"></i></button></a>
                          <?php }  ?>
                          <?php }?>
...
<!-- Tambah Data -->
          ...
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header biru">
                        ...
                        <h4 class="title-putih"> <i class="fa fa-plus"></i> Tambah Data Admin</h4>
                      </div>
    ...
    <?php 
                      ...
                      while ($row = mysql_fetch_assoc($data)) {                      
    ?>
      <div id="detail<?php echo $row['username']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      
          <div class="modal-dialog" style="width: 510px;">
            <div class="modal-content">
                      <div class="modal-header biru-langit">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-close"></i></button>
                        <h4 class="title-putih"><i class="fa fa-eye"></i> Detail Data Admin</h4>
                      </div>
                      <div class="modal-body">
...
<!-- Edit Data -->
    <?php 
                      ...
                      while ($row = mysql_fetch_assoc($data)) {                      
    ?>    
      <div id="edit<?php echo $row['username']; ?>" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
...
<!-- Blokir Data -->
    <?php 
                      ...
                      while ($row = mysql_fetch_assoc($data)) {                      
    ?>    
      <div id="blokir<?php echo $row['username']; ?>" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
