...
$de_les = mysql_fetch_assoc($sql);

$sql_les = mysql_query("SELECT * FROM lesson WHERE lesson_id = '$de_les[lesson_id]' ");
$less = mysql_fetch_assoc($sql_les);

?>

      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-text"></i> Nilai Hasil Ulangan</h2> 
            ...
            <div class="col-md-12">            
             <div class="widget">
                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                  <div style="padding-bottom: 10px;" align="right"><a href="#cetak" data-toggle="modal" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Hasil Ulangan</a></div>   
              <!-- Table Page -->
          ...
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header biru">
                        ...
                        <h4 class="title-putih"> <i class="fa fa-print"></i> Cetak Hasil Ulangan</h4>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-6">  
                            ...
                            while ($ta = mysql_fetch_assoc($thn)) { ?>
