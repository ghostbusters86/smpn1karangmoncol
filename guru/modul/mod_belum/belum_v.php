...
?>
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-text"></i> Data Siswa Belum Mengikuti Ulangan</h2> 
        <div class="bread-crumb pull-right">
          <a href="media.php?module=home"><i class="fa fa-home"></i> Home</a>
          <span class="divider">/</span> 
          <a href="media.php?module=belum" class="bread-current">Data Siswa Belum Mengikuti Ulangan</a>
        </div>
            ...
            <div class="col-md-12">            
             <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Data Ulangan</div>
                ...
                <div class="table-responsive">
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      ...
                      $data = mysql_query("SELECT * FROM exm_schedule, detail_lesson WHERE detail_lesson.detail_lesson_id = exm_schedule.detail_lesson_id AND detail_lesson.nip = '$idgr' ORDER BY exm_schedule_id DESC");
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-3"></div>
                ...
                <div class="widget-head">
                  <div class="pull-left"> <i class="fa fa-file-text"></i> Jadwal Ulangan</div>
                  <div class="widget-icons pull-right">
                  </div>  
                  <div class="clearfix"></div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">            
             <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"> 
                    Data Siswa Yang Belum Mengikuti Ulangan
                  </div>
                  <div class="widget-icons pull-right">
                  </div>  
                  <div class="clearfix"></div>
                ...
                <div class="table-responsive">
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      $data = mysql_query("SELECT * FROM student, class WHERE student.nis NOT IN(SELECT exm_reg.nis FROM exm_reg WHERE exm_schedule_id = '$id' ) AND class.class_id = student.class_id AND student.class_id = '$kr[class_id]' ");
                      while ($row = mysql_fetch_assoc($data)) {
                      ...
                      <tr>
                        ...
                        <td width="120px">
                        <span class="label label-danger">Belum Mendaftar Ulangan</span>
                      ...
                      while ($row = mysql_fetch_assoc($data)) {
                      $sqlsiswa = mysql_query("SELECT * FROM student, class WHERE class.class_id = student.class_id AND student.nis = $row[nis] ");
                      $rosis = mysql_fetch_assoc($sqlsiswa);
                       ?>
                      <tr>
                        ...
                        <td width="120px">
                        <span class="label label-warning">Belum Mengerjakan Ulangan</span>
                      ...
                      <tr>
                        ...
                        <td><?php echo $rosis['class_name']; ?></td>
                        <td width="120px">
                        <span class="label label-success">Sudah Mengerjakan Ulangan</span>
