...
?>
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-calendar"></i> Jadwal Ulangan</h2> 
        <div class="bread-crumb pull-right">
          <a href="media.php?module=home"><i class="fa fa-home"></i> Home</a>
          <span class="divider">/</span> 
          <a href="media.php?module=jadwal" class="bread-current">Jadwal Ulangan</a>
        </div>
            ...
            <div class="col-md-12">            
             <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Data Jadwal Ulangan</div>
                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                  <div style="padding-bottom: 10px;" align="right"><a href="media.php?module=jadwal&act=add" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus"></i> Jadwal Ulangan</a></div>    
              <!-- Table Page -->
          ...
          <div class="modal-dialog" style="width: 500px;">
            <div class="modal-content">
                      <div class="modal-header merah">
                        ...
                        <h4 class="title-putih"><i class="fa fa-trash"></i> Hapus Data Jadwal Ulangan</h4>
                      </div>
...
case 'add';
 ?>
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-calendar"></i> Tambah Jadwal Ulangan</h2> 
        <div class="bread-crumb pull-right">
          <a href="media.php?module=home"><i class="fa fa-home"></i> Home</a>
          <span class="divider">/</span> 
          <a href="media.php?module=jadwal" class="bread-current">Jadwal Ulangan</a>
          <span class="divider">/</span> 
          <a href="media.php?module=jadwal&act=add" class="bread-current">Tambah Jadwal Ulangan</a>
        </div>
        <div class="clearfix"></div>
      </div>
      ...
      <div class="matter">
        <div class="container">
          ...
          <div class="row">
                      ...
                      <p align="center"><b>Pilih mata pelajaran, guru dan kelas yang akan ditambahkan sebagai jadwal Ulangan.</b></p>
                          </div>
                      </div>
                      <div class="col-md-2">
                      </div>
                ...
                <div class="widget-head">
                  <div class="pull-left"> 
                    <a href="media.php?module=jadwal" class="btn btn-default">
                     <i class="fa fa-arrow-left"></i> Jadwal Ulangan
                    </a>
                  </div>
                  <div class="widget-icons pull-right">
                  </div>  
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      ...
                      while ($row = mysql_fetch_assoc($data)) {
                       ...
                       $mapel = mysql_fetch_assoc($pel);

                       $kel = mysql_query("SELECT * FROM class WHERE class_id ='$row[class_id]' ");
                       $kelas = mysql_fetch_assoc($kel);

                       $gu = mysql_query("SELECT * FROM teacher WHERE nip ='$row[nip]'");
                       $guru = mysql_fetch_assoc($gu);
                       ?>
                      <tr>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-8">            
             <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"><i class="fa fa-plus"></i> Tambah Jadwal Ulangan</div>
                  <div class="widget-icons pull-right">
        ...
        <div class="col-md-12">
          <form class="form-horizontal" role="form" method="POST" action="<?php echo $module; ?>&act=insert" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Nama Jadwal Ulangan </label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Pengajar </label>
                        <div class="col-lg-6">
                     <?php 
                              $sql = mysql_query("SELECT * FROM teacher WHERE nip ='$r[nip]'");
                              $tch = mysql_fetch_assoc($sql);
                              ?>
                      ...
                      <label class="col-lg-3 control-label">Formula LCG </label>
                        ...
                        <select name="formula" class="form-control selectlive" required>
                              ...
                              <?php 
                               ...
                               while ($lcg = mysql_fetch_assoc($sql)) { ?>
...
$r = mysql_fetch_assoc($ql);
 ?>
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-pencil"></i> Edit Jadwal Ulangan</h2> 
        <div class="bread-crumb pull-right">
          <a href="media.php?module=home"><i class="fa fa-home"></i> Home</a>
          <span class="divider">/</span> 
          <a href="media.php?module=jadwal" class="bread-current">Jadwal Ulangan</a>
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Edit Jadwal Ulangan</a>
        </div>
        <div class="clearfix"></div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-3"></div>
                ...
                <div class="widget-head">
                  <div class="pull-left"> <i class="fa fa-pencil"></i> Jadwal Ulangan Yang Akan Diedit</div>
                  <div class="widget-icons pull-right">
                  </div>  
                  <div class="clearfix"></div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">            
             <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"> 
                    Pilih Jadwal Ulangan Yang Akan Digantikan
                  </div>
                  <div class="widget-icons pull-right">
                  </div>  
                  <div class="clearfix"></div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-8">            
             <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"><i class="fa fa-pencil"></i> Edit Jadwal Ulangan</div>
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
                    <a href="#" class="wclose"><i class="fa fa-times"></i></a>
                  </div>  
          ...
          <form class="form-horizontal" role="form" method="POST" action="<?php echo $module; ?>&act=update" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="col-lg-3 control-label">Pengajar </label>
                        <div class="col-lg-6">
                     <?php 
                              $sql = mysql_query("SELECT * FROM teacher WHERE nip ='$pljr[nip]'");
                              $tch = mysql_fetch_assoc($sql);
                              ?>
                        ...
                        <select name="ta" class="form-control selectlive" >
                             ...
                             <?php } ?>    
                              ...
                              <?php 
                               ...
                               while ($ta1 = mysql_fetch_assoc($sql1)) { ?>
                      ...
                      <label class="col-lg-3 control-label">Formula LCG </label>
                        ...
                        <select name="formula" class="form-control selectlive" >
                             ...
                             <?php 
                               ...
                               while ($lcg1 = mysql_fetch_assoc($sql1)) { ?>
