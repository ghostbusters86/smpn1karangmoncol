...
$sl = mysql_fetch_assoc($sql);
$dgr = mysql_query("SELECT * FROM question_group WHERE question_group_id = '$id'");
$grp = mysql_fetch_assoc($dgr);
$p = mysql_query("SELECT * FROM lesson WHERE lesson_id = '$grp[lesson_id]' ");
$pljr = mysql_fetch_assoc($p);
$sql= mysql_query("SELECT count(question_id) AS jml FROM question WHERE question_group_id = '$id' ");
                ...
                <div class="table-responsive">
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="99%">
                    ...
                    <tbody>
                      ...
                      while ($soal = mysql_fetch_assoc($qry)) {
                       ?>
                      <tr>
                        <td><?php echo $no; ?></td>
